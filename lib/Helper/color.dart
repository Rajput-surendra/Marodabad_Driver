...
const Color primary =Color(0xffF69420);
const Color secondary = Color(0xff77AF42);
const Color fontColor = Color(0xff000000);
const Color grad1Color = Color(0xffF69420);
const Color grad2Color = Color(0xffF69420);
...
const Color darkColor = Color(0xffF69420);
const Color darkColor2 = Color(0xffF69420);
